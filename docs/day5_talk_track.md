...
- Biggest region driver: West (31.4%)
- Biggest segment driver: Consumer (50.8%)
- Shipping: best Same Day vs worst Standard Class (service gap).

## Customers (1–1.5 min)
- Top 20% customers contribute ~48.3% of sales → retention focus.
